...
class LIBPROTOBUF_EXPORT SourceContext : public ::google_public::protobuf::Message {
 public:
  SourceContext();
  ...
  SourceContext* New(::google_public::protobuf::Arena* arena) const;
...
inline const ::std::string& SourceContext::file_name() const {
  ...
  return file_name_.GetNoArena(&::google_public::protobuf::internal::GetEmptyStringAlreadyInited());
}
